...
abstract class ProfileRepository {
  ...
  Future<void> setOnlineStatus({required String uid, required bool isOnline, required String deviceId});

  Future<void> heartbeatPresence({required String uid, required String deviceId});
