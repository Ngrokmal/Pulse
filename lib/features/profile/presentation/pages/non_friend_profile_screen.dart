...
class _NonFriendProfileView extends StatelessWidget {
  ...
  Future<void> _openChat(BuildContext context, String targetUid, FriendRequestStatus status) async {
    if (status != FriendRequestStatus.friends) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Add this person as a friend to start messaging')),
      );
      return;
    }
                        ...
                        child: Row(
                          children: [
                            ...
                            ProfileActionButton(
                              ...
                              label: 'Message',
                              onTap: state.friendRequestStatus != FriendRequestStatus.friends
                                  ? null
                                  : (onMessage ?? () => _openChat(context, data.uid, state.friendRequestStatus)),
                            ),
                          ],
                        ),
                      ),
